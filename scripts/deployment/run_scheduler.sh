...
# Routed multi-asset AI universe: FX (OANDA), crypto + US equities
# (Alpaca paper; built-in simulator when no Alpaca credentials are set).
export ALPHABRIEF_AI_SCHEDULER_UNIVERSE=EUR_USD,GBP_USD,USD_JPY,BTC-USD,ETH-USD,SOL-USD,AAPL,NVDA,TSLA,SPY,QQQ
